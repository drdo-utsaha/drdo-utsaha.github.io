...
// preloadImage
jQuery.dopreloadImage = function(url, onload) {
    var $img = $('<img />'),
...
// formerize
jQuery.fn.doformerize = function() {
...
(function() {
    ...
    jQuery.fn.doonVisible = function(fn, p) {
        elements.push({
            o: jQuery(this),
            fn: fn,
            pad: (p ? p : pad),
...
jQuery(function() {
    ...
    if (_IEVersion < 10) $('form').doformerize();
    ...
    $('.carousel').each(function() {
        ...
        if (_IEVersion < 9) $t._updatePos = function() {
            $reel.css('left', pos);
        };
    ...
    if ($body.hasClass('homepage')) {
        ...
        if (helios_settings.header.fadeIn) {
            ...
            $window.load(function() {
                ...
                $.dopreloadImage(imageURL, function() {
                    if (_IEVersion < 10) $header.children('.overlay').fadeOut(2000);
    ...
    // Get in touch scroll to the bottom of the page
